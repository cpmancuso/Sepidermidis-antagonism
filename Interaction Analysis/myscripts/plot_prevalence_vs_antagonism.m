function fighandle = plot_prevalence_vs_antagonism(correlation_structure,lineage_labels,fignum)
...
lineage_y = correlation_structure.lineage_prevalence;
sample_x = correlation_structure.lineage_antagonism;
sample_y = correlation_structure.lineage_prevalence;
color_x = '#C03026'; %red
...
title(['Correlation of prevalence and antagonism' newline 'Linear rho = ' num2str(linear_rho,'%.2f') ' p = ' num2str(linear_p,'%.3f')])
legend('hide')
...
xlabel('Lineage')
title(['Correlation of prevalence and antagonism' newline 'Spearman rho = ' num2str(spearman_rho,'%.2f') ' p = ' num2str(spearman_p,'%.3f')])
