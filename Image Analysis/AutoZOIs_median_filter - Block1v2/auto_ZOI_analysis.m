...
load('params.mat')
imagedir = 'C:\Users\cmanc\Dropbox\Lieberman Lab\Personal lab notebooks\Chris Mancuso\Data\220705_Block1v2_ZOI_assay\2022_07_08';
...
old_spots = 'oldspots_2022_07_08.mat';
old_data = '';
...
% load([spots_name '.mat'])
% 
% for i=35 %enter image to correct directly
%     close all
%     figure(1)
%     imshow(img{i})
%     hold on
