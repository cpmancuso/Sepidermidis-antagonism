...
load('params.mat')
imagedir = 'C:\Users\cmanc\Dropbox\Lieberman Lab\Personal lab notebooks\Chris Mancuso\Data\220606_Block1_ZOI_assay\2022_06_09';
...
old_spots = 'oldspots_2022_06_09.mat';
old_data = '';
...
% load([spots_name '.mat'])
% load('calibration.mat')
% for i=96 %enter image to correct directly
%     close all
%     figure(1)
%     imshow(img{i})
%     hold on
