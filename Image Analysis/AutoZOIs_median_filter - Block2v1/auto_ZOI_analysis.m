...
load('params.mat')
imagedir = 'C:\Users\cmanc\Dropbox\Lieberman Lab\Personal lab notebooks\Chris Mancuso\Data\220719_Block2v1_ZOI_assay\2022_07_22';
...
old_spots = 'oldspots_2022_07_22.mat';
old_data = '';
%%
images = dir(imagedir);
...
% load([spots_name '.mat'])
% load('calibration.mat')
% for i=5 %enter image to correct directly
%     close all
%     figure(1)
%     imshow(img{i})
%     hold on
...
for i=1:96
    for n=1:96
        ...
        if (ZOI_depth(i,n)>thresh || ZOI_subarea(i,n)>1000) && (all_radii(i,n)>0);
