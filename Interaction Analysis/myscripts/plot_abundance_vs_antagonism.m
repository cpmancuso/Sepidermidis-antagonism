...
title(['Correlation of sample abundance and antagonism' newline 'Linear rho = ' num2str(linear_rho,'%.2f') ' p = ' num2str(linear_p,'%.3f')])
legend('hide')
...
xlabel('Lineage')
title(['Correlation of mean abundance and antagonism' newline 'Spearman rho = ' num2str(spearman_rho,'%.2f') ' p = ' num2str(spearman_p,'%.3f')])
